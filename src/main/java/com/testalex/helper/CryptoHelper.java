...
public class CryptoHelper {
    ...
    public void checkPassword(String text, String encodedText) throws ExampleTestAlexException {
        if (!validate(text, encodedText)) {
            throw new ExampleTestAlexException(MessageHelper.MESSAGE_ERROR_CHECK_PASS);
        }
    }
